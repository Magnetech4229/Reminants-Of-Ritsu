...
public class Robot extends SampleRobot {
	...
	final int kJoystickChannel_1 = 0;
	final int kJoystickChannel_2 = 1;
	
	Joystick stick_1 = new Joystick(kJoystickChannel_1);
	Joystick stick_2 = new Joystick(kJoystickChannel_2);
	...
	public void operatorControl() {
		...
		while (isOperatorControl() && isEnabled()) {
			...
			// is set to zero.
			robotDrive.mecanumDrive_Cartesian(stick_1.getX(), stick_1.getY(), stick_1.getZ(), 0);
